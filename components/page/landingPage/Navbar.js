...
const NavBar = () => {
    ...
    return(
        ...
        <nav className="bg-white flex flex-col lg:flex-row py-4 fixed w-full z-20 overflow-hidden">
            ...
            <Link href="/">
                    <li className="mx-3 hover:text-green-700" onClick={() =>setOpen(prev => !prev)}><a href="">Home</a></li>
                </Link>
                <li className="mx-3 hover:text-green-700" onClick={() =>setOpen(prev => !prev)}><a href="#services">Services</a></li>
                <li className="mx-3 hover:text-green-700" onClick={() =>setOpen(prev => !prev)}><a href="#about-us">About Us</a></li>
                <li className="mx-3 hover:text-green-700" onClick={() =>setOpen(prev => !prev)}><a href="#testimonials">Testimonials</a></li>
                <li className="mx-3 hover:text-green-700" onClick={() =>setOpen(prev => !prev)}><a href="#contact-us">Contact Us</a></li>
                    <Link href="/login">
                        <button className="flex  text-white px-4 pt-1 rounded-md w-24 ml-2 h-10 pt-2 " onClick={() =>setOpen(prev => !prev)} style={{backgroundColor:'#3C8224'}}>
                            Login
                        </button>
                    </Link>
                </ul> 
