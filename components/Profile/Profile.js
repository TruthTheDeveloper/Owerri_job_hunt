                ...
                <div className=" bg-green-500 flex flex-row">
                    <div className="flex flex-col">
                        <div className="mr-24 ml-6 my-4 rounded-full bg-yellow-600 overflow-hidden">
                            <Image src={angel} width={200} height={200} />
                        </div>
                        ...
                        <div className="flex m-2">
                            <a href="#"><FontAwesomeIcon size='x' style={{color:"#14A800"}}  icon={faEnvelope} className="w-4 h-4 mx-1 mt-1"  /></a> Henrysempire111@gmail.com
                        </div>
                    </div>
                    <div>
