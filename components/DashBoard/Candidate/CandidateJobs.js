...
const CandidateJobs = () => {
    ...
    return(
      ...
      <CandidateHoc>
          ...
          <Jobs image={sponsor10} jobTitle={'Talent Manager'} jobDescription={'Counsel talent concerning professional matters'} location={'Apapa, lagos, Nigeria (Remote)'}/>
          ...
          <Jobs image={sponsor4} jobTitle={'Content Writer'} jobDescription={'create print and digital content for companies that provides information or showcases the products or services they offer'} location={'aldinma, Owerri, Nigeria (Remote)'}/>
          <Jobs image={sponsor8} jobTitle={'Sales Manager'} jobDescription={'lead sales teams to reach sales targets,setting quotas, evaluating and adjusting performance.'} location={'aldinma, Owerri, Nigeria (Remote)'}/>
          <Jobs image={sponsor12} jobTitle={'Product Designer'} jobDescription={'responsible for the design and development of consumer products'} location={'aldinma, Owerri, Nigeria (Remote)'}/>
          <Jobs image={sponsor6} jobTitle={'Digital Marketer'} jobDescription={'boost brand awareness while driving traffic to acquire new customers'} location={'aldinma, Owerri, Nigeria (Remote)'}/>
